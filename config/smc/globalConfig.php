...
return [
    ...
    'global' => [
        ...
        'dingDingToken' => '5a877be5025c991b81bbbdb6134d404aee8bf2ee50a4c96e2179f0829b40b1b8', //钉钉机器人token
        ...
        'queueCfgCallback' => [], //系统会检测此回调方法，实现队列配置热加载，格式：call_user_func_array方法的第一个参数，如果不使用热加载，可以使用以下的 amqp 配置的示例
        'logPath' => APP_ROOT.'/logs/smc/', //日志文件路径
